...
import CreateProductModal from "./CreateProductModeal";
        ...
        <div className="mx-auto pb-5 w-full">
            <div className="mb-6">
                <div className="flex items-center border-2 border-gray-200 rounded">
                    ...
                    <input className="w-full py-2 px-4 rounded bg-white" placeholder="Search products" value={searchTerm} onChange={(e)=> setSerachTerm(e.target.value)}/>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button className="flex items-center bg-blue-500 hover:bg-blue-700 text-gray-200 font-bold py-2 px-4 rounded" onClick={()=> setIsModalOpen(true)}>
                    <PlusCircleIcon className="w-5 h-5 mr-2 !test-gray-200"/> create
                </button>
