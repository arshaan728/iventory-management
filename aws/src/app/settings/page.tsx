                ...
                <table className="min-w-full bg-white rounded-lg">
                    <thead className="bg-gray-80 text-white">
                        <tr>
                          ...
                          <tbody>
                            {userSettings.map((setting , index)=>(
                                ...
                                <td className="py-2 px-4"> {setting.label}
                      ...
                      ></div>
                                    ...
                                    (
                                        <input type="text" className="px-4 py-2 border rounded-lg text-gray-500 focus:outline-none focus:border-blue-50" value={setting.value as string} onChange={(e)=> {
                                            const settingsCopy = [...userSettings];
